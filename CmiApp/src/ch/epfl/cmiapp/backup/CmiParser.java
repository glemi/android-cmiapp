...
public class CmiParser 
{
	...
	*/
	...
	{
		String url = "https://cmisrvm1.epfl.ch/spc/utilSB/include/tabUtilLimit.php?hauteur=800";
	...
	{
		String url = "https://cmisrvm1.epfl.ch/reservation/reserv.php?login=%s&password=%s";
